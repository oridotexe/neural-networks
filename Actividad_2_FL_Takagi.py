...
def graficar(FS, input_temperatura):

    FS.set_variable("peces", 22)
    FS.set_variable("temperatura", input_temperatura)
    ...
    ax.set_title("Superficie Takagi-Sugeno: Oxígeno en Pecera")
    plt.tight_layout()
    plt.show()
...
graficar(FS, input_temperatura=30)