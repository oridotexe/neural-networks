...
def mamdani():
    ...
    return simulador, oxigeno

def graficar(simulador, oxigeno, input_temperatura):
    # Ejemplo: 22 peces y 30°C
    simulador.input['peces'] = 22
    simulador.input['temperatura'] = input_temperatura
    simulador.compute()
...
graficar(simulador_mamdani, oxigeno_mamdani, input_temperatura=30)